...
def main():
    main_folder_path = '/home/tawheed/parseq/data/crr-wrr/new/images/0'
    output_folder_path = '/home/tawheed/parseq/data/crr-wrr/new/pred'
    
    model_path = '/home/tawheed/parseq/outputs/parseq/urdu_500x64/checkpoints/last.ckpt'
